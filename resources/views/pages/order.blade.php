...
<section class="container mx-auto">     
    <div class="grid grid-col-1 sm:grid-cols-4 my-4 gap-x-4 gap-y-4 mx-4 ">
        <div class="col-span-4 xl:col-span-3 bg-primary-one rounded-xl ">
            <div class=" text-center ">
                <div class="bg-[#6ec1e4] py-2 px-5 rounded-t-xl ">
        ...
        @endif
            ...
            <form class="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-2 px-10  py-8" id="order-form" method="POST" action="{{ route('order.store') }}" enctype="multipart/form-data">
                ...
                <div class="w-full">
                    <input id="phone" name="Phone" type="tel" name="phone" class="w-full text-gray-700 rounded border border-gray-300 bg-white  focus:border-primary-two focus:ring-2 focus:ring-primary-two text-base outline-none px-3 leading-8 transition-colors duration-200 ease-in-out placeholder-gray-600" placeholder="Phone" value="{{ old('phone') }}"
                ...
                <div class="w-full">
                    <select name="subject" type="text" class="w-full text-gray-700 rounded border border-gray-300 bg-white  focus:border-primary-two focus:ring-2 focus:ring-primary-two text-base outline-none py-1 px-3 leading-8 transition-colors duration-200 ease-in-out ">
                ...
                <div class="w-full">
                    <select name="style"  class="w-full text-gray-700 rounded border border-gray-300 bg-white  focus:border-primary-two focus:ring-2 focus:ring-primary-two text-base outline-none py-1 px-3 leading-8 transition-colors duration-200 ease-in-out ">
                ...
                <div class="w-full">
                    <select name="reference_style" type="text" class="w-full text-gray-700 rounded border border-gray-300 bg-white  focus:border-primary-two focus:ring-2 focus:ring-primary-two text-base outline-none py-1 px-3 leading-8 transition-colors duration-200 ease-in-out ">
        ...
        <div class=" col-start-2 col-span-2 xl:col-span-1 flex flex-col space-y-8">
            ...
            <div class="border border-t-4 border-b-4 border-primary-two py-2 px-5 rounded-t-lg rounded-b-lg p-5 flex flex-col md:ml-auto w-full ">
                ...
                <img class="h-6 " src="{{ asset('imgs/payment-methods.png') }}" alt="" class="mx-auto">
            </div>
